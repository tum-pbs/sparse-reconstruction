...
def get_channel():
    ...
    p = {
        ...
        "Spatial Start": [1, 1],
        "Spatial End": [2048, 512],
        "Spatial Step": [1, 1],
        "Z Slices": [1, 301, 601, 901, 1201],
        "Temporal Start": 1,
        "Temporal End": 4000,
        "Temporal Step": 10,
        "Constants": [],
...
def get_isotropic1024coarse():
    ...
    p = {
        ...
        "Spatial Start": [1, 1],
        "Spatial End": [1024, 1024],
        "Spatial Step": [1, 1],
        "Z Slices": [1, 201, 401, 601, 801],
        "Temporal Start": 1,
        "Temporal End": 5000,
        "Temporal Step": 10,
        "Constants": [],
...
def get_transition_bl():
    ...
    p = {
        ...
        "Dt (full)": 0.25,
        "Boundary Conditions Order": ["x negative", "x positive", "y negative", "y positive"],
        "Boundary Conditions": ["open", "open", "wall", "open"],
        "Spatial Start": [1272, 1],
        "Spatial End": [3319, 224],
        "Spatial Step": [1, 1],
        "Z Slices": [1, 401, 801, 1201, 1601],
        "Temporal Start": 1,
        "Temporal End": 4700,
        "Temporal Step": 5,
        "Constants": [],
