...
from pbdl.torch.dataset import Dataset3D as PBDLDataset

from .variable_dt_dataset import VariableDtDataset


'''
    Datasets generated with exponax solver from Köhler et al.: APEBench: A Benchmark for Autoregressive Neural Emulators of PDEs.
'''
seed = 44


def ape_3d_datasets(dataset_name: str,
    ...
    if dataset_name in ["ks", "gs_alpha", "gs_beta", "gs_gamma", "gs_epsilon"]:
    ...
    # joint training and test data file, split by simulation
        ...
        elif dataset_name in ["adv", "diff", "adv-diff", "disp", "hyp", "burgers", "kdv", "fisher", "sh"]:
...
def ape_3d_transforms(dataset_name: str)-> tuple[Transform, Transform, Transform]:
    r'''
