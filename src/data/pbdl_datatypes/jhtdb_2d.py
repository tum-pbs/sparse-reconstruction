...
'''
    2D Datasets created via slicing 3D simulations downloaded from the JHTDB
'''
seed = 47


def jhtdb_2d_datasets(dataset_name: str,
...
def jhtdb_2d_transforms(dataset_name: str)-> tuple[Transform, Transform, Transform]:
    r'''
