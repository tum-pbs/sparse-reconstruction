...
class KarrasUnet(ModelMixin, ConfigMixin):
    """
    ...
    def __init__(
        ...
        *,
        ...
        num_classes = 1000,       # in paper, they do 1000 classes for a popular benchmark
        in_channels = 4,             # 4 channels in paper for some reason, must be alpha channel?
        out_channels = 4,
        num_downsamples = 3,
...
class KarrasUNetWrapper(KarrasUnet):
    ...
    def forward(
        ...
        output = super().forward(hidden_states, timestep, class_labels=class_labels)
