###############################################################################
###############################################################################
### File for Quick Testing of Global Context with Scale/Shift Conditioning  ###
###############################################################################
...
class ContextModelV2(nn.Module):
    def __init__(
        self,
        in_dim,
        mlp_ratio=4,
    ...
    def init_weights(self):
        """Initialize the region tokens for sending back feedback to the decoder."""
...
class NestedTokenizationV2(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        self.xT = xTV2(self.model_impl, xt_config, crop_size=crop_size,
...
class xTV2(AbstractModel):
    def __init__(
        ...
        **kwargs,
        ...
        # freeze the weights of self.backbone
    ...
    def forward(self,
        ...
        #
        # seq_out, region_emb = self.seq2seq(hidden_states[-1])
        #
        ...
        #
        #
        # output3d = self.backbone.decode(x, emb, hidden_states, control=region_emb)
        #
        # return output3d
        ...
        #         emb_encoder = self.__getattr__("emb_encoder_" + str(i))
        #         enc = emb_encoder(region_emb)[0]
        #         emb_updated.append(emb[i] + enc)
